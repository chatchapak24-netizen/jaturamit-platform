      ...
      {error ? (
        ...
        <section className="grid gap-5 md:grid-cols-3">
          ...
          <article className="rounded-2xl border border-white/10 bg-zinc-900 p-5">
            ...
            <h2 className="mt-3 text-2xl font-black">38 stars</h2>
            <p className="mt-2 text-sm text-zinc-400">
              Maximum 5 players from the same school/team.
            </p>
          </article>
          <article className="rounded-2xl border border-white/10 bg-zinc-900 p-5">
            <p className="text-xs font-black uppercase tracking-[0.24em] text-red-300">
            ...
            <p className="mt-2 text-sm text-zinc-400">
              Existing Arena weeks are reused as fantasy matchdays.
            </p>
          </article>
        </section>
      )}
      ...
      <section className="mt-8 rounded-2xl border border-white/10 bg-zinc-900 p-6">
        ...
        <div className="mt-5 grid gap-3">
            ...
            >
              <div>
                ...
                <p className="text-sm text-zinc-500">
                  Lock: {week.lineup_locks_at || "not set"}
                </p>
              </div>
          ...
          {visibleWeeks.length === 0 && !error ? (
            <p className="text-zinc-400">No fantasy week is open yet.</p>
          ) : null}
        </div>
      </section>
    </main>
